...
App.createMarkers = function() {
			...
			pt.marker = new google.maps.Marker({
			  ...
			  map: App.globals.locationMap
                        ...
                        if ($("#"+pt.code).attr("lang") == 'eng') {  
                            infodata = infodata + "<b> " + $("#"+pt.code).attr("name") + "</b> <br /> ";
                            if ($("#"+pt.code).attr("location") == undefined ||
                                    $("#"+pt.code).attr("location") == '-') {}
                            else {
                                infodata = infodata +
                                    "Address: " +  $("#"+pt.code).attr("location") + "<br />";
                            }

                            if ($("#"+pt.code).attr("publicpobox") == undefined ||
                                    $("#"+pt.code).attr("publicpobox") == 'N/A'  ||
                                    $("#"+pt.code).attr("publicpobox") == '') {}
                            else {
                                infodata = infodata +
                                    " Public P.O.Box: " +  $("#"+pt.code).attr("publicpobox") + "<br />";
                            }
                            infodata = infodata +
                                    " Open: " +  $("#"+pt.code).attr("weekday") + "<br />"
                                    + "Timings: " +  $("#"+pt.code).attr("timings") + "<br />"
                                    + "GPS: "
                                    +  $("#"+pt.code).attr("gpslat") + ", "
                                    +  $("#"+pt.code).attr("gpslon")+"</div>";
                            ...
                            if ($("#"+pt.code).attr("location") == undefined ||
                                ...
                                infodata = infodata +
                                    "ایڈریس: " +  $("#"+pt.code).attr("location") + "<br />";
                            }
                            ...
                            if ($("#"+pt.code).attr("publicpobox") == undefined ||
                                ...
                                infodata = infodata +
                                    "عوامی پی او باکس سروس: " +  $("#"+pt.code).attr("publicpobox") + "<br />";
                            }
                            infodata = infodata +
                                    "دن کھلی: " +  $("#"+pt.code).attr("weekday") + "<br />"
                                    + "اوقات: " +  $("#"+pt.code).attr("timings") + "<br />"
                                    + "نقشے کے نقاط: "
                                    +  $("#"+pt.code).attr("gpslat") + ", "
                                    +  $("#"+pt.code).attr("gpslon")+"</div>";
                        }
                            ...
                            if ($("#"+pt.code).attr("location") == undefined ||
                                ...
                                infodata = infodata +
                                    "عنوان: " +  $("#"+pt.code).attr("location") + "<br />";
                            }
                            ...
                            if ($("#"+pt.code).attr("publicpobox") == undefined ||
                                ...
                                infodata = infodata +
                                    " رقم صندوق الجمهور: " +  $("#"+pt.code).attr("publicpobox") + "<br />";
                            }
                            infodata = infodata +
                                    " أيام العمل: " +  $("#"+pt.code).attr("weekday") + "<br />"
                                    + "ساعات العمل: " +  $("#"+pt.code).attr("timings") + "<br />"
                                    + "إحداثيات المركز : "
                                    +  $("#"+pt.code).attr("gpslat") + ", "
                                    +  $("#"+pt.code).attr("gpslon")+"</div>";
                        }
	...
	App.globals.locationMap.setCenter(new google.maps.LatLng(points[0].gps_lat, points[0].gps_long));
}
...
App.triggerMarker = function(marker) {
  ...
  App.mapMoveToPoint = function(el) {     
   ...
   // $('#blkMe').block({ showOverlay: true, fadeIn:  200, timeout: 1000 }); 
    ...
    $.blockUI({ showOverlay: true, fadeIn:  200, timeout: 1000,
            message: '<h5> يرجى الانتظار </h5><h5>Please wait </h5><h5>برائے مہربانی انتظار کریں</h5>',
            centerY: 0,
